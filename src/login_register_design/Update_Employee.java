...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,lab,lab1,id20;
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t20;
    JButton b,b1,b2,b3; 
    String id_emp;
    ...
    Update_Employee(String idaa){
        ...
        id20= new JLabel("Student Id:");
        id20.setBounds(400,300,100,30);
        id20.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id20);
        f.setVisible(false);
        
        t20=new JTextField();
        t20.setBounds(600,300,150,30);
        id15.add(t20);
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from employee where studentid = '"+s+"'";
        ...
        if(ae.getSource()==b){
            try{
                ...
                String str = "update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',"
                        + "phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',institute='"+t7.getText()+"',aadhar='"+t8.getText()+"',"
                        + "course='"+t9.getText()+"',studentid='"+t20.getText()+"' where studentid='"+id_emp+"'";
