...
class Print_Data implements ActionListener{
    ...
    String studentid,name,father,address,phone,email,education,institute,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;

    Print_Data(String studentid){
        try{
            conn con = new conn();
            String str = "select * from employee where studentid = '"+studentid+"'";
